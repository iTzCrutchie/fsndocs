...
| -------     | -------- | ----------- |
| `f`         | function | The function you wish to run |
| `ms`        | number   | Number of seconds to repeat the function for |
...
### Util.CreateBlip
*Easy way for creating blips with 1 line*

| Argument    | Type     | Description |
| -------     | -------- | ----------- |
| `name`      | string   | The name of the blip in the GTA Map |
| `sprite`    | number   | Sprite of the blip, [FiveM Blip Sprites](https://docs.fivem.net/docs/game-references/blips/) |
| `color`     | number   | The color the blip should be, [FiveM Blip Colors](https://gtaforums.com/topic/864881-all-blip-color-ids-pictured/) |
|`range`      | bollean  | true/false to set the blip as short range |
